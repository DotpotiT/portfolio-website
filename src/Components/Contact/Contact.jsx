...
const Contact = () => {
  ...
  return (
    <div className="mx-auto lg:mt-20" >
      ...
      <div className="mt-10 md:w-full mx-auto my-10 relative">
       ...
       <div className='py-16 h-[65vh] lg:h-[55vh]  p-2' style={{
    backgroundImage: 'url("https://res.cloudinary.com/dgohi0iqm/image/upload/v1705159069/ec85z8mt3tzxcbr1rvgn.png")',
    ...
    <h1 className='text-center text-xl lg:text-3xl text-white py-2 lg:py-5'>Contact Us</h1>
  ...
  <div
  className="form-control w-full my-2 lg:my-5"
>
  <textarea
    cols="30"
    rows="3"
